						...
						<div class="btn-group me-2">
							<form action="ServletFornecedor" method="post">
								<button class="btn btn-warning mb-3" type="submit"
									name="optionFornecedor" value="insertFormSupplier">
									...
									<span class="text-dark fw-bold"> Adicionar Fornecedor</span>
						...
						<tbody>
							...
							<c:forEach var="supplier" items="${listSupplier}">
								...
								<tr class="tabela">
									...
									<form action="ServletFornecedor" method="post" class="fornecedor">

										<td class="text-center numerofornecedor"><c:out value="${supplier.cod_fornecedor}" /> <input
											type="hidden" name="cod_fornecedor"
											value="${supplier.cod_fornecedor}" /></td>

										<td><c:out value="${supplier.razao_social}" /></td>
										
										<span class="">Resultado = ${requestScope.chaveEstrangeira}</span>
										...
										<td>
											<div class="d-grid gap-2 d-md-flex justify-content-md-center">
												...
												<button class="btn btn-warning" type="submit"
													name="optionFornecedor" value="updateFormSupplier">
