						...
						<div
							...
							<div class="accordion-item">
								<h2 class="accordion-header "
									id="flush-heading-${c.cod_cliente}">
									<button class="accordion-button collapsed ac-header"
										type="button" data-bs-toggle="collapse"
										data-bs-target="#flush-collapse-${c.cod_cliente}"
										aria-expanded="false"
										aria-controls="flush-collapse-${c.cod_cliente}">
										...
										<div class="row col-12 col-md-12 col-lg-12">
											...
											<div class="col-xs-12 col-md-5 text-start fw-bolder">
												<span class="d-none d-sm-block"> </span> <span> <c:out
														value="${c.nome_cliente} ${c.razao_social}" />
												</span>
											</div>
										</div>
								...
								<div id="flush-collapse-${c.cod_cliente}"
												...
												<c:forEach var="ped" items="${Pedido}">
													<c:choose>
														<c:when test="${c.cod_cliente == ped.cod_cliente}">
															<p>
																<strong> Nº Pedido : ${ped.cod_pedido}</strong>
															</p>
															<p>
																Valor Pedido : <strong>R$ <fmt:formatNumber
															...
															<p>
																<strong> Valor Frete :<fmt:formatNumber
																		type="number" maxFractionDigits="2"
																		minFractionDigits="2" value="${ped.valor_frete}" />
																</strong>
															</p>
															<br>
														</c:when>
													...
													<c:choose>
														<c:when test="${c.cod_cliente == end.cod_cliente}">
															<p class="exampleInputCep">
																<strong>Cep : ${end.cep_endereco}</strong>
															</p>
															<p>Cidade : ${end.cidade} UF - [ ${end.uf} ]</p>
															<p>Logradouro : ${end.rua_endereco}
																${end.numero_endereco} ${end.complemento}</p>
